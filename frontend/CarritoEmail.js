      ...
      <head>
        ...
        <style>
          @media only screen and (max-width: 480px) {
            ...
            .item-row td { display: block !important; width: 100% !important; text-align: left !important; padding: 5px 0 !important; }
            .item-row td:last-child { border-bottom: 1px solid #eeeeee; padding-bottom: 15px !important; text-align: right !important; }
            .header-info td { display: block !important; width: 100% !important; text-align: left !important; }
            .header-info td:last-child { text-align: left !important; margin-top: 10px; }
            .banner-img { height: auto !important; }
          }
        </style>
      </head>
      <body style="background-color: #f4f4f4; margin: 0; padding: 0; font-family: 'Segoe UI', Arial, sans-serif;">
        <div class="container" style="padding: 20px;">
          <div style="max-width: 600px; margin: auto; background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 15px rgba(0,0,0,0.1);">
            ...
            <div style="background-color: #48110d; padding: 30px; text-align: center;">
              <img src="https://raw.githubusercontent.com/CarlosNamias/menu/main/public/img/logooo.png" alt="El Corral" style="max-width: 180px;">
            </div>
            ...
            <div class="content" style="padding: 40px 30px;">
              ...
              <div style="text-align: center; margin: 20px 0;">
                <img class="banner-img" src="https://raw.githubusercontent.com/CarlosNamias/menu/main/public/img/carrusel-1.jpg" alt="Hamburguesas El Corral" style="width: 100%; max-width: 500px; border-radius: 8px;">
              </div>
              ...
              <div style="background-color: #fff8f5; border: 1px dashed #f58b2d; border-radius: 8px; padding: 20px; margin: 30px 0;">
                <table class="header-info" style="width: 100%; border-collapse: collapse;">
                  <tr>
                    <td style="padding-bottom: 5px;">
                      <div style="font-size: 11px; color: #888888; text-transform: uppercase; margin-bottom: 4px;">ID del Pedido</div>
                      <div style="font-size: 16px; color: #333333; font-weight: bold;">#${pedido.id}</div>
                    </td>
                    <td style="text-align: right; padding-bottom: 5px;">
                      <div style="font-size: 11px; color: #888888; text-transform: uppercase; margin-bottom: 4px;">Fecha</div>
                      <div style="font-size: 15px; color: #333333; font-weight: bold;">${pedido.fecha}</div>
                    </td>
                  </tr>
                </table>
              </div>
              ...
              <table style="width: 100%; border-collapse: collapse;">
                ...
                <tbody>
                  ${pedido.items.map(item => `
                    <tr class="item-row" style="border-bottom: 1px solid #eeeeee;">
